ulimit -s unlimited
ulimit -c 0
gfortran budget.f -o budget
./budget < input/dyall_basis/Og_VDZ.inp
gfortran -mcmodel=large -O4 bertha.f -o bertha -llapack -lblas
./bertha < input/dyall_basis/Og_VDZ.inp
#
# In the following:
