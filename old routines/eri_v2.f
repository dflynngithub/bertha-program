      SUBROUTINE ERI(RR,XYZ,KQN,MQN,EXPT,NFUNS,ITQN,IBAS,JBAS)
...
C
      SAVE EAB11,EAB21,ECD11,ECD21,RC
      SAVE IAB11,IAB21,ICD11,ICD21,IRC
C
...
C
C**********************************************************************C
C     HERMITE TWO-BODY INTEGRAL PREPARATION AND EVALUATION - RC(ABCD)  C
C**********************************************************************C
C
...
C     EMPTY Q-LISTS
      ...
      ENDDO
C
C     MULTIPLY REAL AND IMAG. PARTS OF G(AB|--) BY E(AB|--)
      DO IAB=1,NTUVAB
