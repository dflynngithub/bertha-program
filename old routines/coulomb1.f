...
C                                                                      C
C -------------------------------------------------------------------- C
C  COULOMB1 CONSTRUCTS ALL ONE-CENTER CONTRIBUTIONS TO THE MOLECULAR   C
...
C**********************************************************************C
      PARAMETER(MDM=2200,MBS=44,MB2=MBS*MBS,MCT=15,MKP=13,MNU=MKP+1,
     &                                                      MAB=2*MNU+6)
C
      CHARACTER*4 HMLTN
C
...
C       BATCH OF RADIAL INTEGRALS (EFFECTIVE INTERACTION STRENGTHS)
        CALL CPU_TIME(T1)
        CALL RKCLM1(KQN,LQN,NBAS(3)*NBAS(4))
        CALL CPU_TIME(T2)
        TC1R = TC1R+T2-T1
C
C**********************************************************************C
...
C
C
      SUBROUTINE RKCLM1(KQN,LQN,MAXM)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C**********************************************************************C
C                                                                      C
...
C                                                                      C
C -------------------------------------------------------------------- C
C  RKCLM1 EVALUATES A BATCH OF GENERAL (OPEN-SHELL) ONE-CENTER RADIAL  C
...
C**********************************************************************C
      PARAMETER(MCT=15,MBS=44,MB2=MBS*MBS,MKP=13,MNU=MKP+1,MAB=2*MNU+6)
C
      DIMENSION LQN(4)
